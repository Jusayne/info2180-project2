...
class Contact{
        ...
        function get_contactID(){
            ...
            if($link === false){
                ...
                $sql_check = "SELECT id FROM contacts WHERE firstname = '$this->fname'" ;
        ...
        function addContact(){
            ...
            if($link === false){
                ...
                if ($result->num_rows == 1){
                    ...
                    $sql_check = "UPDATE contacts SET title = '$this->title',firstname = '$this->fname',lastname = '$this->lname',email = '$this->email', telephone = '$this->telephone', company = '$this->company', type = '$this->type', assigned_to = '$this->assigned_to' WHERE id = '$id'" ;
